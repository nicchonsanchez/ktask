    ...
    return (
      <div className="bg-bg border-border w-full max-w-md rounded-lg border p-8 shadow-sm">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-fg text-lg font-semibold">Verifique seu email</h1>
          <p className="text-fg-muted mt-2 text-sm leading-relaxed">
            Se <strong className="text-fg">{getValues('email')}</strong> tem conta no KTask, você
            receberá um link pra redefinir sua senha em alguns minutos. O link vale por 1 hora.
          </p>
          <p className="text-fg-subtle mt-4 text-xs">
            Não chegou? Verifique a pasta de spam, ou{' '}
            <button
              type="button"
  ...
  return (
    <div className="bg-bg border-border w-full max-w-md rounded-lg border p-8 shadow-sm">
      ...
      <p className="text-fg-muted mt-1 text-sm">
        Digite o email da sua conta — enviaremos um link pra criar uma nova senha.
      </p>
