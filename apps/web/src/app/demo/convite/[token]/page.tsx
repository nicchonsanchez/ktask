 ...
 *
 * Usa primitivos do @ktask/ui (Button, Input, Label) pra manter paridade
 * visual com a tela real.
 */
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="bg-bg-subtle border-border w-full max-w-md rounded-xl border p-6 shadow-sm">
        ...
        <div className="bg-bg-muted text-fg-muted border-border mb-6 rounded-md border p-3 text-xs">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="name" type="text" defaultValue="Marina Costa" />
          </div>

          <div className="flex flex-col gap-1.5">
            <Label htmlFor="email">E-mail</Label>
            <Input id="email" type="email" defaultValue="marina@padariaaurora.com.br" disabled />
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="pwd">Crie sua senha</Label>
